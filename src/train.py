...
def train_dynamic_brain():
    ...
    m1 = xgb.XGBClassifier(n_estimators=100, learning_rate=0.05, max_depth=5).fit(X_train, y_train)
    ...
    m2 = xgb.XGBRegressor(n_estimators=100, learning_rate=0.05, max_depth=5).fit(X_train_c, y_train_c)
    ...
    m3 = xgb.XGBRegressor(n_estimators=100, learning_rate=0.05, max_depth=5).fit(X_train_s, y_train_s)
    ...
    m4 = xgb.XGBRegressor(n_estimators=100, learning_rate=0.05, max_depth=5).fit(X_train_t, y_train_t)
